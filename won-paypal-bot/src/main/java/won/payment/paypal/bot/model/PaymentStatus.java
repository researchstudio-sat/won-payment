...
public enum PaymentStatus {
    NOWHERE, // Connection created; Merchant Connection stored; Merchant does not have
             // accepted the message yet
    BUILDING, // Merchant is passing information to the bot, until the goal is reached and the
              // merchant accepts the proposal
    // Payment states:
