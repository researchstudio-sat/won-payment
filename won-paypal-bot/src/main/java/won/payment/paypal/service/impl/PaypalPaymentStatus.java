...
public enum PaypalPaymentStatus {
    CREATED("CREATED"), COMPLETED("COMPLETED"), ERROR("ERROR"), EXPIRED("EXPIRED"), INCOMPLETE("INCOMPLETE"),
    PROCESSING("PROCESSING"), PENDING("PENDING"), REVERSALERROR("REVERSALERROR");
