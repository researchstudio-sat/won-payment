...
public class WONPAY {
    ...
    // public static final Property HAS_SECRET = m.createProperty(BASE_URI +
    // "hasSecret");
    ...
    public static class CUR {
        ...
        public static final Resource BRL = m.createResource(BASE_URI + "BRL").addLiteral(CODE, "BRL").addLiteral(SIGN,
                        "R$");
